...
public abstract class CompileStrategy {
   ...
   */
  private final Set<String> compiledModuleNames = new HashSet<String>();
   ...
   * @param testClass the test class containing the test
   * @param batchingStrategy the batching strategy
   */
  public void maybeAddTestBlockForCurrentTest(GWTTestCase testCase, Class<?> testClass, 
